...
describe("Property Auction System", () => {
  it("should create an auction successfully", () => {
    ...
    const { result } = simnet.callPublicFn(
      ...
      [Cl.uint(2), Cl.uint(50000), Cl.uint(144)],
      address1
    );
    expect(result).toBeOk(Cl.uint(1));
  });
  ...
  it("should place bids successfully", () => {
    ...
    simnet.callPublicFn(
      contractName,
      "create-property-auction",
      [Cl.uint(3), Cl.uint(60000), Cl.uint(200)],
      address1
    );
  ...
  it("should end auction after duration expires", () => {
    ...
    simnet.callPublicFn(
      contractName,
      "create-property-auction",
      [Cl.uint(4), Cl.uint(55000), Cl.uint(10)],
      address1
    );
  ...
  it("should prevent unauthorized auction creation", () => {
    ...
    const { result } = simnet.callPublicFn(
      contractName,
      "create-property-auction",
      [Cl.uint(5), Cl.uint(40000), Cl.uint(100)],
